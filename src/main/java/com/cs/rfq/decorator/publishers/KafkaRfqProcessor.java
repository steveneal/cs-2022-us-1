...
public class KafkaRfqProcessor {
    private static final String KAFKA_SERVER = "localhots: 9092";
    ...
    public JavaDStream<String> initRfqStream() {
        ...
        JavaInputDStream<ConsumerRecord<String, String>> records = KafkaUtils.createDirectStream(streamingContext,
